...
export default function Search() {
  return (
    <div className=' dark:bg-gray-900 py-2 px-4 md:px-6'>
      <div className='max-w-8xl  bg-white dark:bg-gray-800 rounded-lg mx-7  p-6 md:p-8'>
        <h2 className='text-3xl font-bold mb-6'>Find your next adventure</h2>
        <form className='grid grid-cols-1 md:grid-cols-4 gap-14'>
          ...
          <div className='space-x-2 '>
            <Button
              className='px-20 mt-8 ml-7 bg-blue-700 hover:bg-teal-500'
              type='submit'>
              Search
            </Button>
          </div>
